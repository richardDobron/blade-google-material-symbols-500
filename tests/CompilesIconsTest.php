...
use dobron\BladeMaterialSymbols\BladeGoogleMaterialDesignSymbols500ServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('gms:500-fact_check-fill-outlined')->toHtml();
        $this->assertMatchesXmlSnapshot($result);
    }

    public function testIconContainsClasses()
    {
        $result = svg('gms:500-done_outline-fill-outlined', 'w-6 h-6 text-gray-500')->toHtml();
        $this->assertMatchesXmlSnapshot($result);
    }

    public function testIconContainsStyles()
    {
        $result = svg('gms:500-wb_sunny-fill-sharp', ['style' => 'color: #555'])->toHtml();
        $this->assertMatchesXmlSnapshot($result);
    }
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            BladeGoogleMaterialDesignSymbols500ServiceProvider::class,
        ];
    }
}
